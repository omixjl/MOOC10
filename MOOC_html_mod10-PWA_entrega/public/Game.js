...
class Game {
    ...
    constructor() {
        ...
        this.score = 0; // Refleja la puntuacion inicial
        this.lives = 3; // Refleja las vidas
    }
    ...
    endGame() {
        ...
        if (game.score > 0 && game.lives > 0) {
            let win = new Entity(this, this.width / 2, "auto", this.width / 4, this.height / 4, 0, WIN_PICTURE)
            win.render();
        }
    }
